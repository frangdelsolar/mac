...
class ClientViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['id', 'administrator__first_name', 'administrator__last_name', 'administrator__username', 'client_type__name', 'client_plan__name']
    ordering_fields = ['id', 'administrator__username', 'client_type__name', 'client_plan__name']
