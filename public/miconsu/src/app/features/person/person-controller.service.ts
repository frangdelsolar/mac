...
export class PersonService {
  ...
  _apiUrl = environment.apiUrlPerson;
  ...
  public getById(id: number){
    return this.adminSvc.get<Person>(this._apiUrl, id, true);
  }

  public create(body: Person){
    return this.adminSvc.post<Person>(this._apiUrl, body, true);
  }

  public update(id: number, body: Person){
    return this.adminSvc.put<Person>(this._apiUrl, body, id, true);
  }
