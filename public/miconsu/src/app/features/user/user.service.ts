...
export class UserService {
  ...
  _apiUrl = environment.apiUrlUser;
  ...
  public getById(id: number){
    return this.adminSvc.get<User>(this._apiUrl, id, true);
  }

  public create(body: User){
    return this.adminSvc.post<User>(this._apiUrl, body, true);
  }

  public update(id: number, body: User){
    return this.adminSvc.put<User>(this._apiUrl, body, id, true);
  }
