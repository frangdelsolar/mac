...
export class ClientTypeService {
  ...
  _apiUrl = environment.apiUrlClientType;
  ...
  public getById(id: number){
    return this.adminSvc.get<ClientType>(this._apiUrl, id, true);
  }

  public create(body: ClientType){
    return this.adminSvc.post<ClientType>(this._apiUrl, body, true);
  }

  public update(id: number, body: ClientType){
    return this.adminSvc.put<ClientType>(this._apiUrl, body, id, true);
  }
